...
PID: 1426
Date: 2015-08-07 11:02:31(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 1426, uid 5000)

Register Information
r0   = 0xbeea0d68, r1   = 0x00000004
r2   = 0x00000001, r3   = 0x00000000
r4   = 0x00000000, r5   = 0x00000000
r6   = 0x00000001, r7   = 0x001bb4e0
r8   = 0x00000004, r9   = 0xbeea0d68
r10  = 0x00000004, fp   = 0xbeea0d70
ip   = 0xb6b919d0, sp   = 0xbeea0d40
lr   = 0xb26f24a8, pc   = 0xb6b919f0
cpsr = 0x28000010
...
Callstack Information (PID:1426)
Call Stack Count: 41
 0: fwrite + 0x20 (0xb6b919f0) [/lib/libc.so.6] + 0x589f0
 1: (0xb26f24a8) [/opt/apps/kfYcpFyaST/bin/Argos1.1.exe] + 0x44a8
 2: (0xb37e41cf) [/usr/lib/osp/libosp-uifw.so] + 0x3861cf
 3: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2c0 (0xb42de1c5) [/usr/lib/osp/libosp-appfw.so] + 0x1561c5
 4: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb42de3fb) [/usr/lib/osp/libosp-appfw.so] + 0x1563fb
 5: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb42de4ed) [/usr/lib/osp/libosp-appfw.so] + 0x1564ed
 6: (0xb38ecae7) [/usr/lib/osp/libosp-uifw.so] + 0x48eae7
 7: (0xb37e19bf) [/usr/lib/osp/libosp-uifw.so] + 0x3839bf
 8: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2c0 (0xb42de1c5) [/usr/lib/osp/libosp-appfw.so] + 0x1561c5
 9: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb42de3fb) [/usr/lib/osp/libosp-appfw.so] + 0x1563fb
10: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb42de4ed) [/usr/lib/osp/libosp-appfw.so] + 0x1564ed
11: Tizen::Ui::Controls::_Button::FireActionEvent() + 0x26 (0xb37eb47f) [/usr/lib/osp/libosp-uifw.so] + 0x38d47f
12: (0xb37edfa1) [/usr/lib/osp/libosp-uifw.so] + 0x38ffa1
13: Tizen::Ui::Controls::_Button::OnTouchReleased(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0xe (0xb37e92b3) [/usr/lib/osp/libosp-uifw.so] + 0x38b2b3
14: Tizen::Ui::_ControlImpl::CallOnTouchReleased(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0x21a (0xb372502f) [/usr/lib/osp/libosp-uifw.so] + 0x2c702f
15: Tizen::Ui::_ControlImpl::_PropagatedTouchEventListener::OnTouchReleased(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0x200 (0xb372ce95) [/usr/lib/osp/libosp-uifw.so] + 0x2cee95
16: Tizen::Ui::_UiTouchEvent::FireListener(Tizen::Ui::_ITouchEventListener const*, Tizen::Ui::_Control const*, bool, bool&) + 0x280 (0xb3792965) [/usr/lib/osp/libosp-uifw.so] + 0x334965
17: Tizen::Ui::_UiTouchEvent::OnEventProcessing(Tizen::Ui::_Control const&, bool&) + 0x62 (0xb3792e9b) [/usr/lib/osp/libosp-uifw.so] + 0x334e9b
18: Tizen::Ui::_UiEvent::ProcessEvent(Tizen::Ui::_Control const&, bool&) + 0x32 (0xb3786fab) [/usr/lib/osp/libosp-uifw.so] + 0x328fab
19: Tizen::Ui::_UiEventManager::ProcessBubblingEvent(Tizen::Base::Collection::LinkedListT<Tizen::Base::_HandleT<Tizen::Ui::_Control> > const&, Tizen::Ui::_UiEvent const&, bool&) + 0x78 (0xb3787959) [/usr/lib/osp/libosp-uifw.so] + 0x329959
20: Tizen::Ui::_UiEventManager::ProcessEvent(Tizen::Ui::_UiEvent const&, bool&) + 0x234 (0xb3787c2d) [/usr/lib/osp/libosp-uifw.so] + 0x329c2d
21: Tizen::Ui::_UiEventManager::Fire(Tizen::Ui::_UiEvent const&) + 0x8c (0xb3787d11) [/usr/lib/osp/libosp-uifw.so] + 0x329d11
22: Tizen::Ui::_UiEventManager::SendEvent(Tizen::Ui::_UiEvent const&) + 0x6 (0xb3787da3) [/usr/lib/osp/libosp-uifw.so] + 0x329da3
23: (0xb3776c3f) [/usr/lib/osp/libosp-uifw.so] + 0x318c3f
24: (0xb3778b07) [/usr/lib/osp/libosp-uifw.so] + 0x31ab07
25: (0xb3779041) [/usr/lib/osp/libosp-uifw.so] + 0x31b041
26: _ecore_timer_expired_call + 0xc2 (0xb690d86f) [/usr/lib/libecore.so.1] + 0xd86f
27: _ecore_timer_expired_timers_call + 0xe (0xb690d97b) [/usr/lib/libecore.so.1] + 0xd97b
28: _ecore_main_loop_iterate_internal + 0x26 (0xb690b03b) [/usr/lib/libecore.so.1] + 0xb03b
29: ecore_main_loop_begin + 0x30 (0xb690b5cd) [/usr/lib/libecore.so.1] + 0xb5cd
30: elm_run + 0x6 (0xb69d419f) [/usr/lib/libelementary.so.1] + 0xa819f
31: appcore_efl_main + 0x2d4 (0xb6f597d5) [/usr/lib/libappcore-efl.so.1] + 0x27d5
32: app_efl_main + 0xc6 (0xb3f28e63) [/usr/lib/libcapi-appfw-application.so.0] + 0x6e63
33: Tizen::App::_AppImpl::Execute(Tizen::App::_IAppImpl*) + 0xe6 (0xb42758b3) [/usr/lib/osp/libosp-appfw.so] + 0xed8b3
34: Tizen::App::UiApp::Execute(Tizen::App::UiApp* (*)(), Tizen::Base::Collection::IList const*) + 0x64 (0xb3b091f9) [/usr/lib/osp/libosp-uifw.so] + 0x6ab1f9
35: OspMain + 0xbc (0xb26f180c) [/opt/apps/kfYcpFyaST/bin/Argos1.1.exe] + 0x380c
36: main + 0x194 (0xb6a66f21) [/opt/apps/kfYcpFyaST/bin/Argos1.1] + 0xf21
37: __launchpad_main_loop + 0xe54 (0xb259) [/usr/bin/launchpad_preloading_preinitializing_daemon] + 0xb259
38: main + 0x486 (0xbcb3) [/usr/bin/launchpad_preloading_preinitializing_daemon] + 0xbcb3
39: __libc_start_main + 0x114 (0xb6b4e6e8) [/lib/libc.so.6] + 0x156e8
40: (0xa110) [/usr/bin/launchpad_preloading_preinitializing_daemon] + 0xa110
End of Call Stack
