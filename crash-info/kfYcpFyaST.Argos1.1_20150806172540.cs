...
PID: 2572
Date: 2015-08-06 17:25:40(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 2572, uid 5000)

Register Information
r0   = 0xbea26d68, r1   = 0x00000004
r2   = 0x00000004, r3   = 0x00000000
r4   = 0x00000067, r5   = 0x00000000
r6   = 0x00000004, r7   = 0x00196730
r8   = 0x00000010, r9   = 0xbea26d68
r10  = 0x00000004, fp   = 0xbea26d70
ip   = 0xb6b1d9d0, sp   = 0xbea26d40
lr   = 0xb267e404, pc   = 0xb6b1d9f0
cpsr = 0x28000010
...
Callstack Information (PID:2572)
Call Stack Count: 41
 0: fwrite + 0x20 (0xb6b1d9f0) [/lib/libc.so.6] + 0x589f0
 1: non-virtual thunk to Argos1_1MainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x54 (0xb267e404) [/opt/apps/kfYcpFyaST/bin/Argos1.1.exe] + 0x4404
End of Call Stack
