...
PID: 1928
Date: 2015-08-06 17:18:25(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 1928, uid 5000)

Register Information
r0   = 0x00000065, r1   = 0x00177a68
r2   = 0x00000065, r3   = 0xb2687544
r4   = 0x00000065, r5   = 0x00141e98
r6   = 0x00000065, r7   = 0x001bbad8
r8   = 0xbea26e58, r9   = 0x000aca90
r10  = 0xb4430940, fp   = 0xbea26d68
ip   = 0xb6b1c108, sp   = 0xbea26d40
lr   = 0xb267e408, pc   = 0xb6b1c110
cpsr = 0x68000010
...
Callstack Information (PID:1928)
Call Stack Count: 42
 0: fclose + 0x8 (0xb6b1c110) [/lib/libc.so.6] + 0x57110
 1: Argos1_1MainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x90 (0xb267e408) [/opt/apps/kfYcpFyaST/bin/Argos1.1.exe] + 0x4408
 2: non-virtual thunk to Argos1_1MainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0xc (0xb267e42c) [/opt/apps/kfYcpFyaST/bin/Argos1.1.exe] + 0x442c
End of Call Stack
