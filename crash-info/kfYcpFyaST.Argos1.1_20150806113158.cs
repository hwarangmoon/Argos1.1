...
PID: 4560
Date: 2015-08-06 11:31:58(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 4560, uid 5000)

Register Information
r0   = 0x00000065, r1   = 0x00177b98
r2   = 0x00000065, r3   = 0xb26fb674
r4   = 0x00000065, r5   = 0x00141fc8
r6   = 0x00000065, r7   = 0x001bbc08
r8   = 0xbeea0e58, r9   = 0x000acc10
r10  = 0xb44a4940, fp   = 0xbeea0d68
ip   = 0xb6b90108, sp   = 0xbeea0d40
lr   = 0xb26f2420, pc   = 0xb6b90110
cpsr = 0x68000010
...
Callstack Information (PID:4560)
Call Stack Count: 42
 0: fclose + 0x8 (0xb6b90110) [/lib/libc.so.6] + 0x57110
 1: Argos1_1MainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x90 (0xb26f2420) [/opt/apps/kfYcpFyaST/bin/Argos1.1.exe] + 0x4420
 2: non-virtual thunk to Argos1_1MainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0xc (0xb26f2444) [/opt/apps/kfYcpFyaST/bin/Argos1.1.exe] + 0x4444
End of Call Stack
