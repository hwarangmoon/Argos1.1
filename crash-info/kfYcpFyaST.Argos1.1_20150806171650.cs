...
PID: 1628
Date: 2015-08-06 17:16:50(GMT+0900)
...
Callstack Information (PID:1628)
Call Stack Count: 42
 0: fwrite + 0x20 (0xb6b1d9f0) [/lib/libc.so.6] + 0x589f0
 1: (0xb267e400) [/opt/apps/kfYcpFyaST/bin/Argos1.1.exe] + 0x4400
 2: (0xb267e42c) [/opt/apps/kfYcpFyaST/bin/Argos1.1.exe] + 0x442c
 3: (0xb37701cf) [/usr/lib/osp/libosp-uifw.so] + 0x3861cf
 ...
 7: (0xb3878ae7) [/usr/lib/osp/libosp-uifw.so] + 0x48eae7
 8: (0xb376d9bf) [/usr/lib/osp/libosp-uifw.so] + 0x3839bf
 9: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2c0 (0xb426a1c5) [/usr/lib/osp/libosp-appfw.so] + 0x1561c5
10: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb426a3fb) [/usr/lib/osp/libosp-appfw.so] + 0x1563fb
11: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb426a4ed) [/usr/lib/osp/libosp-appfw.so] + 0x1564ed
12: Tizen::Ui::Controls::_Button::FireActionEvent() + 0x26 (0xb377747f) [/usr/lib/osp/libosp-uifw.so] + 0x38d47f
13: (0xb3779fa1) [/usr/lib/osp/libosp-uifw.so] + 0x38ffa1
14: Tizen::Ui::Controls::_Button::OnTouchReleased(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0xe (0xb37752b3) [/usr/lib/osp/libosp-uifw.so] + 0x38b2b3
15: Tizen::Ui::_ControlImpl::CallOnTouchReleased(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0x21a (0xb36b102f) [/usr/lib/osp/libosp-uifw.so] + 0x2c702f
16: Tizen::Ui::_ControlImpl::_PropagatedTouchEventListener::OnTouchReleased(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0x200 (0xb36b8e95) [/usr/lib/osp/libosp-uifw.so] + 0x2cee95
17: Tizen::Ui::_UiTouchEvent::FireListener(Tizen::Ui::_ITouchEventListener const*, Tizen::Ui::_Control const*, bool, bool&) + 0x280 (0xb371e965) [/usr/lib/osp/libosp-uifw.so] + 0x334965
18: Tizen::Ui::_UiTouchEvent::OnEventProcessing(Tizen::Ui::_Control const&, bool&) + 0x62 (0xb371ee9b) [/usr/lib/osp/libosp-uifw.so] + 0x334e9b
19: Tizen::Ui::_UiEvent::ProcessEvent(Tizen::Ui::_Control const&, bool&) + 0x32 (0xb3712fab) [/usr/lib/osp/libosp-uifw.so] + 0x328fab
20: Tizen::Ui::_UiEventManager::ProcessBubblingEvent(Tizen::Base::Collection::LinkedListT<Tizen::Base::_HandleT<Tizen::Ui::_Control> > const&, Tizen::Ui::_UiEvent const&, bool&) + 0x78 (0xb3713959) [/usr/lib/osp/libosp-uifw.so] + 0x329959
21: Tizen::Ui::_UiEventManager::ProcessEvent(Tizen::Ui::_UiEvent const&, bool&) + 0x234 (0xb3713c2d) [/usr/lib/osp/libosp-uifw.so] + 0x329c2d
22: Tizen::Ui::_UiEventManager::Fire(Tizen::Ui::_UiEvent const&) + 0x8c (0xb3713d11) [/usr/lib/osp/libosp-uifw.so] + 0x329d11
23: Tizen::Ui::_UiEventManager::SendEvent(Tizen::Ui::_UiEvent const&) + 0x6 (0xb3713da3) [/usr/lib/osp/libosp-uifw.so] + 0x329da3
24: (0xb3702c3f) [/usr/lib/osp/libosp-uifw.so] + 0x318c3f
25: (0xb3704b07) [/usr/lib/osp/libosp-uifw.so] + 0x31ab07
26: (0xb3705041) [/usr/lib/osp/libosp-uifw.so] + 0x31b041
27: _ecore_timer_expired_call + 0xc2 (0xb689986f) [/usr/lib/libecore.so.1] + 0xd86f
28: _ecore_timer_expired_timers_call + 0xe (0xb689997b) [/usr/lib/libecore.so.1] + 0xd97b
29: _ecore_main_loop_iterate_internal + 0x26 (0xb689703b) [/usr/lib/libecore.so.1] + 0xb03b
30: ecore_main_loop_begin + 0x30 (0xb68975cd) [/usr/lib/libecore.so.1] + 0xb5cd
31: elm_run + 0x6 (0xb696019f) [/usr/lib/libelementary.so.1] + 0xa819f
32: appcore_efl_main + 0x2d4 (0xb6ee57d5) [/usr/lib/libappcore-efl.so.1] + 0x27d5
33: app_efl_main + 0xc6 (0xb3eb4e63) [/usr/lib/libcapi-appfw-application.so.0] + 0x6e63
34: Tizen::App::_AppImpl::Execute(Tizen::App::_IAppImpl*) + 0xe6 (0xb42018b3) [/usr/lib/osp/libosp-appfw.so] + 0xed8b3
35: Tizen::App::UiApp::Execute(Tizen::App::UiApp* (*)(), Tizen::Base::Collection::IList const*) + 0x64 (0xb3a951f9) [/usr/lib/osp/libosp-uifw.so] + 0x6ab1f9
36: OspMain + 0xbc (0xb267d7f4) [/opt/apps/kfYcpFyaST/bin/Argos1.1.exe] + 0x37f4
37: main + 0x194 (0xb69f2f21) [/opt/apps/kfYcpFyaST/bin/Argos1.1] + 0xf21
38: __launchpad_main_loop + 0xe54 (0xb259) [/usr/bin/launchpad_preloading_preinitializing_daemon] + 0xb259
39: main + 0x486 (0xbcb3) [/usr/bin/launchpad_preloading_preinitializing_daemon] + 0xbcb3
40: __libc_start_main + 0x114 (0xb6ada6e8) [/lib/libc.so.6] + 0x156e8
41: (0xa110) [/usr/bin/launchpad_preloading_preinitializing_daemon] + 0xa110
End of Call Stack
