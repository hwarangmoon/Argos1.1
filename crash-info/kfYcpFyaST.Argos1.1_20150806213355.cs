...
PID: 6272
Date: 2015-08-06 21:33:55(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 6272, uid 5000)

Register Information
r0   = 0xb69fc4d0, r1   = 0xb267e9df
r2   = 0xbea26d58, r3   = 0x00000010
r4   = 0xbea26d58, r5   = 0x00000000
r6   = 0x001b13a8, r7   = 0x001bb7d0
r8   = 0xbea26e58, r9   = 0x000acde8
r10  = 0xb267e9df, fp   = 0xbea26d44
ip   = 0xb6b0911c, sp   = 0xbea267f0
lr   = 0xb6b000d8, pc   = 0xb6b000d8
cpsr = 0x68000010
...
Callstack Information (PID:6272)
Call Stack Count: 43
 0: _IO_vfprintf + 0x20 (0xb6b000d8) [/lib/libc.so.6] + 0x3b0d8
 1: _IO_fprintf + 0x20 (0xb6b0913c) [/lib/libc.so.6] + 0x4413c
 2: Argos1_1MainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x94 (0xb267e43c) [/opt/apps/kfYcpFyaST/bin/Argos1.1.exe] + 0x443c
 3: non-virtual thunk to Argos1_1MainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0xc (0xb267e46c) [/opt/apps/kfYcpFyaST/bin/Argos1.1.exe] + 0x446c
End of Call Stack
