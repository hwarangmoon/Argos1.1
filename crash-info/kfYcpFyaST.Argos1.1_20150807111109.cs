...
PID: 2507
Date: 2015-08-07 11:11:09(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 2507, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000004
r2   = 0x00000000, r3   = 0x00000000
r4   = 0xb26f1804, r5   = 0x00141eb0
r6   = 0x00000000, r7   = 0x00196728
r8   = 0xbeea0df0, r9   = 0x000acaf8
r10  = 0xb44a4940, fp   = 0xbeea0cd8
ip   = 0xb6b90108, sp   = 0xbeea0c60
lr   = 0xb26f17d0, pc   = 0xb6b90110
cpsr = 0x68000010
...
b1dca000 b1dcf000 r-xp /usr/lib/libhaptic-module.so
b1dd7000 b215b000 rw-s anon_inode:exynos_gem
b215b000 b24df000 rw-s anon_inode:exynos_gem
b26ad000 b26ae000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b26bd000 b26c0000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b26c8000 b26d2000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b26da000 b26e3000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b26ec000 b26f4000 r-xp /opt/usr/apps/kfYcpFyaST/bin/Argos1.1.exe
...
Callstack Information (PID:2507)
Call Stack Count: 42
 0: fclose + 0x8 (0xb6b90110) [/lib/libc.so.6] + 0x57110
 1: Argos1_1MainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x1c0 (0xb26f17d0) [/opt/apps/kfYcpFyaST/bin/Argos1.1.exe] + 0x57d0
 2: non-virtual thunk to Argos1_1MainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb26f1840) [/opt/apps/kfYcpFyaST/bin/Argos1.1.exe] + 0x5840
End of Call Stack
